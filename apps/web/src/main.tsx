...
type Report = { id: string; title: string; status: string; blocks?: Block[] };
...
createRoot(document.getElementById('root')!).render(<><App /><ContentBlockModal /><ReportEmptyBlockButton /><ReportBlockReorderControls /></>);
